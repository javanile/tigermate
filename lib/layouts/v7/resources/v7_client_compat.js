	...
	showModalWindow: function (data, callback) {
		...
		if (typeof data === 'object' && data !== null && !(data instanceof jQuery)) {
			...
			if (typeof data.cb === 'function') {
				modalParams.cb = data.cb;
			}
			if (typeof data.css !== 'undefined') {
				modalParams.css = data.css;
			}
			if (typeof data.overlayCss !== 'undefined') {
				modalParams.overlayCss = data.overlayCss;
			}
			if (typeof data.backDrop !== 'undefined') {
				modalParams.backDrop = data.backDrop;
			}
			if (typeof data.enhanceUi !== 'undefined') {
				modalParams.enhanceUi = data.enhanceUi;
			}
		}
		return app.helper.showModal(modalContent, modalParams);
	},
	hidePopup: function () {
