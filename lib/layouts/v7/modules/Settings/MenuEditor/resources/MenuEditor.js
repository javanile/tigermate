...
jQuery.Class('Settings_Menu_Editor_Js', {}, {
	...
	registerAddModule : function(container) {
		...
		container.on('click', '.menuEditorAddItem:not(.menuEditorCustomLinkAddItem)', function(e) {
	...
	registerAddCustomLink : function(container) {
		var thisInstance = this;
		container.on('click', '.menuEditorCustomLinkAddItem', function(e) {
			e.preventDefault();
			e.stopPropagation();
	...
	registerEvents : function() {
		...
		this.registerAddCustomLink(container);
