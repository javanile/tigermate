...
value="{$FIELD_VALUE}" data-fieldinfo='{$FIELD_INFO}' data-decimal-symbol="{$DECIMAL_SYMBOL}" {if !empty($SPECIAL_VALIDATOR)}data-validator={Zend_Json::encode($SPECIAL_VALIDATOR)}{/if} />
{/strip}
